...
from gcn.models2 import GCN, MLP
...
flags.DEFINE_string('adj_index', '0','adj_index')

flags.DEFINE_integer('epochs', 200, 'Number of epochs to train.')
flags.DEFINE_integer('num_layers', 2, 'Number of epochs to train.')
...
# Load data
#seed = 1
adj, features, y_train, y_val, y_test, train_mask, val_mask, test_mask, graph = load_data(FLAGS.dataset)
