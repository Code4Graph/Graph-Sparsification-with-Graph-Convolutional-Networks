...
class GraphConvolution(Layer):
    ...
    def __init__(self, layerid, input_dim, output_dim, placeholders, dropout=0.,
        ...
        self.weights = placeholders['weights'] #add
        self.sparse_inputs = sparse_inputs
        self.featureless = featureless
        self.bias = bias
        ...
        #with tf.variable_scope('_vars'):
            ...
            for i in range(1):
                self.vars['weights_' + str(i)] = self.weights[layerid]
                #self.vars['weights_' + str(i)] = glorot([input_dim, output_dim],name='weights_' + str(i)) #delete
                # tf.add_to_collection('weight', self.vars['weights_' + str(i)]) #delete
